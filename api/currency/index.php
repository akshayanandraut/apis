...
else 
{
		...
		else
		{
			...
			{	
				$output = '<?xml version="1.0"?><data><item><from>'.$from.'</from><to>'.$to.'</to><amount>'.$amount.'</amount><response>'.$value.'</response></item></data>';
			}
			...
			{
				$output =  '{"data":[{"from":"'.$from.'","to":"'.$to.'","amount":"'.$amount.'","response":"'.$value.'"}]}';
			}
